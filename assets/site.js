...
const dictionaries = {
  'zh-CN': {
    ...
    privacyPage: {
      ...
      principlesTitle: '页面结构沿用官网现有设计语言，只把隐私相关信息收束成更清晰的层级。',
      principlesBody: '重点说明本地优先、安全存储和用户可控三件事，避免把政策页做成与首页脱节的单独视觉实验。',
      summary1Badge: '本地',
      summary1Kicker: '本地优先',
  ...
  en: {
    ...
    privacyPage: {
      ...
      principlesTitle: 'The page follows the same design language as the rest of the website and only tightens the privacy content into a clearer structure.',
      principlesBody: 'The emphasis stays on three points: local-first processing, secure handling of sensitive data, and user control over records.',
      summary1Badge: 'LF',
